...
def formatAllTweetsforNltkEng():
  ...
  for i in range(len(allTweets)):
    ...
    print(removeStopWordsAndTokenize(stopwordsEn, toTokenize))
    allTweets[i].tweet = removeStopWordsAndTokenize(stopwordsEn, toTokenize)

def main():
  loadEnglishCsvToTweetObject()
  formatAllTweetsforNltkEng()
